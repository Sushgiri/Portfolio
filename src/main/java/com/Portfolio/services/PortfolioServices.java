...
public class PortfolioServices {
    ...
    public ResponseEntity<byte[]> DownloadCVRequest() throws Exception {
        ClassPathResource pdfFile = new ClassPathResource("static/files/SUSHIL GIRI RESUME.pdf");

        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_PDF);
        headers.setContentDispositionFormData("attachment", "SUSHIL GIRI RESUME.pdf");
